...
This module extends of the customer portal, it's work with groups now, adds the easy invoices in the template,
and adds team tickets to the user.
...
1. Go to users and set the group in "Easy invoices web" rule.
...
This module is part of the `Custom-Central <https://github.com/calyx-servicios/custom-centralsabores>`_ project on Github.